...
export function Tooltip({
  ...
  useLayoutEffect(() => {
    ...
    let canonTop = 0;
    switch (placement) {
      case 'top':    canonLeft = coords.left - w / 2; canonTop = coords.top - h; break;
      case 'bottom': canonLeft = coords.left - w / 2; canonTop = coords.top; break;
      case 'left':   canonLeft = coords.left - w;     canonTop = coords.top - h / 2; break;
      case 'right':  canonLeft = coords.left;         canonTop = coords.top - h / 2; break;
    }
