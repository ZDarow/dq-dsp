...
// Bit depth selected via CONFIG_UAC_BIT_DEPTH (16 or 24). Wire-bytes are the
// minimum container holding the resolution: 16 -> 2 bytes, 24 -> 3 bytes.
#define CFG_TUD_AUDIO_FUNC_1_FORMAT_1_N_BYTES_PER_SAMPLE_TX          ((CONFIG_UAC_BIT_DEPTH + 7) / 8)
#define CFG_TUD_AUDIO_FUNC_1_FORMAT_1_RESOLUTION_TX                  CONFIG_UAC_BIT_DEPTH
#define CFG_TUD_AUDIO_FUNC_1_FORMAT_1_N_BYTES_PER_SAMPLE_RX          ((CONFIG_UAC_BIT_DEPTH + 7) / 8)
#define CFG_TUD_AUDIO_FUNC_1_FORMAT_1_RESOLUTION_RX                  CONFIG_UAC_BIT_DEPTH
